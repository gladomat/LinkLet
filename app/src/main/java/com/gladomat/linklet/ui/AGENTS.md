...
All visual code: `MainActivity` (single activity, NavHost with 8 routes), screens, reusable components, Material 3 theme. State comes from `viewmodel/` — no repository or storage access from composables.
